...
type Creator struct {
	...
	Workcode string `protobuf:"bytes,6,opt,name=workcode,proto3" json:"workcode,omitempty"`
}
...
func (x *Creator) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
func (x *Creator) GetRealname() string {
	if x != nil {
		return x.Realname
	}
	return ""
...
func (x *Creator) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *Creator) GetWorkcode() string {
	if x != nil {
		return x.Workcode
	}
	return ""
...
var file_creator_proto_rawDesc = []byte{
	...
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x22, 0x9b, 0x01, 0x0a, 0x07, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x6f, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x09, 0x52, 0x08, 0x72, 0x65, 0x61, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1a, 0x0a, 0x08, 0x77, 0x6f, 0x72,
	0x6b, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x77, 0x6f, 0x72,
	0x6b, 0x63, 0x6f, 0x64, 0x65, 0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
...
var file_creator_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_creator_proto_goTypes = []interface{}{
	(*Creator)(nil), // 0: protoc.Creator
}
